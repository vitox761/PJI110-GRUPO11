    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Animal_idAnimal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='grupo11.animalmodel')),
                ('Clinica_idClinica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='grupo11.clinicamodel')),
                ('Animal_Tutor_idTutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='grupo11.tutormodel')),
            ],
        ),
        migrations.AddField(
